...
const FormTemplate = ({ parkingZone, url, method }: FormTemplateProps) => {
    ...
    return (
        <Card className="mx-auto w-full max-w-2xl">
            <CardHeader>
                <CardTitle>
                    {parkingZone ? 'Edit Parking Zone' : 'Create Parking Zone'}
                </CardTitle>
                <CardDescription>
                    {parkingZone
            ...
            <CardContent>
                <Form action={url} method={method} className="space-y-6">
                    {({ processing, errors }) => (
                        <>
                                    ...
                                    {isPaid && (
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Optional link where users can
                                                pay or view pricing information
                                            </p>
                                            <InputError
                                                message={errors.payment_url}
                                            />
                                        </div>
                                    )}
                                </div>
